...
#define DECRYPT_HEADER_SAVE_BLOCKSIZE   (1024 * 1024)
#define DECRYPT_HEADER_SAVE_BLOCKCNT    (10)
#define DECRYPT_HEADER_SAVE_SIZE_BYTES  (DECRYPT_HEADER_SAVE_BLOCKCNT * DECRYPT_HEADER_SAVE_BLOCKSIZE)
